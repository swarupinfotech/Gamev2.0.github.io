window.onload = function(){
    ...
    for(var n = 0; n < levels.length; n++){
        document.querySelector(".level:nth-child("+(n+1)+")").addEventListener("click",function(){
            ...
            nextBtnCnt.style.display = "block";
            starCnt.style.display = "block";
            compl.innerHTML = 'Level Complete <a id="buymeacoffee" href="https://www.buymeacoffee.com/swarupinfo4" target="_blank" rel="noopener noreferrer"><img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me a Coffee" style="height: 51px !important; width: 217px !important;"></a>';
            compl.style.display = "block";
            play("levelStart");
        })
    }
